...
exports.createCheckoutSession = async (req, res) => {
    ...
    try {
        ...
        const origin = req.headers.origin || 'https://numee-app-backend.caprover-testing.mtechub.com';  // Fallback to localhost if origin is undefined
...
exports.cancelSubscription = async (req, res) => {
    try {
        ...
        const subscriptionEndDate = new Date(subscription.current_period_end * 1000).toLocaleDateString();
